...
Perform auth, secrets, and configuration review directly from the bundled layer
reference. Do not delegate to agents or skills outside this reviewer bundle.
