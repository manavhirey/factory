...
| No conventions detected | Use documented repository defaults; otherwise report insufficient evidence | local review |
...
| Pattern seen once | Record as weak evidence; do not persist or promote it | local review |
| Pattern confirmed 3+ times | Report the observed convention and supporting examples | local review |
