...
description: >
  ...
  architecture-design workflow instead.
---
...
- NOT for choosing an architecture — this bundle reviews existing boundaries
...
- `/security-scan` — depth on authentication and authorization side-findings
